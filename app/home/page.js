...
const MEMBERS = [
  {
    ...
    text: '"Join Planet Longhorn and make friends from all over the world. It\'s like having a global family right here at UT Austin!"',
    bgcolor: "#FFC6C6",
    country: "Netherland",
  },
  {
    ...
    imageSrc: petar,
    name: "Petar",
    text: '"Being part of Planet Longhorn means turning strangers into lifelong friends. It\'s not just about the places we explore, but the incredible people we meet along the way.',
    bgcolor: "#D6CABD",
    country: "Macedonia",
  },
  {
    ...
    imageSrc: komie,
    name: "Komie",
    text: '"At Planet Longhorn, we\'re not just creating memories; we\'re crafting a global family. Come be a part of something extraordinary!"',
    bgcolor: "#BECAED",
    country: "Houston",
  },
];
